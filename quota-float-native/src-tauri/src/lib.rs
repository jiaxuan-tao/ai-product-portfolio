...
fn setup_tray(app: &tauri::App) -> tauri::Result<()> {
    let show = MenuItem::with_id(app, "show", "显示或隐藏", true, None::<&str>)?;
    let refresh = MenuItem::with_id(app, "refresh", "立即刷新", true, None::<&str>)?;
    let unlock = MenuItem::with_id(app, "unlock", "解锁悬浮窗", true, None::<&str>)?;
    let pin = MenuItem::with_id(app, "pin", "固定或取消固定 Codex", true, None::<&str>)?;
    ...
    let menu = Menu::with_items(app, &[&show, &refresh, &unlock, &pin, &autostart, &quit])?;
    let mut builder = TrayIconBuilder::with_id("main")
        .menu(&menu)
        .tooltip("Quota Float Native");
    ...
    let app = tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let client = reqwest::Client::builder()
                ...
                .user_agent("QuotaFloatNative/0.1")
                .build()
        ...
        .expect("failed to build Quota Float Native");
