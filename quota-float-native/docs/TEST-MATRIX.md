...
| 构建 | Windows unsigned 包 | 生成 `quota-float-native-windows-unsigned.zip` | CI/Release 验证 |
| 构建 | macOS Universal unsigned 包 | 生成 `quota-float-native-macos-universal-unsigned.zip`，支持 Apple Silicon 和 Intel | CI/Release 验证 |
